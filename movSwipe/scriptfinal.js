    ...
    function stopDrag() {
      ...
      if (Math.abs(offsetX) > threshold) {
        ...
        if (frontCard) {
          ...
          // Send data to the corresponding PHP script
          const data = {
            title: shuffledMovies[currentMovieIndex].title,
            year: shuffledMovies[currentMovieIndex].year,
            genres: shuffledMovies[currentMovieIndex].genres,
          };
          ...
          if (isSwipeRight) {
            ...
            sendToPHP('storeHistory.php', data);
          }
        }
      }
...
function sendToPHP(script, data) {
  ...
  axios.post(`http://your-server-domain/${script}`, data)
    .then(response => {
